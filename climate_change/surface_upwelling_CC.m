...
ref=mean(struct2array(load(fullfile(p1,'W_diff_depth10.mat'), 'W10m')),3,'omitnan');
Tplus=mean(struct2array(load(fullfile(p2,'W_diff_depth10.mat'), 'W10m')),3,'omitnan');
Wminus=mean(struct2array(load(fullfile(p3,'W_diff_depth10.mat'), 'W10m')),3,'omitnan');
Wplus=mean(struct2array(load(fullfile(p4,'W_diff_depth10.mat'), 'W10m')),3,'omitnan');
