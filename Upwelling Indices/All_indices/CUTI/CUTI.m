...
%% Coriolis
pcolor(LON(:,1),latiCUTI(1,:),f'); shading flat; colorbar;
borders('countries','facecolor','white');
axis([-90 -70 -33 10]); 
%%
...
pcolor(LON,LAT,UEK.*mask); shading flat;
hold on
[c,h]=contour(LON,LAT,CUTI.*mask,[0:0.5:5],'k');
caxis([-5 5])
clabel(c,h);
cmocean('delta');
borders('countries','facecolor','white');
...
title('Long-term mean of ocean (1990-2010) UGEO','fontsize',16); 
%% PLOT CUTI
Humboldt_ports;
grey = [0.5 0.5 0.5];
