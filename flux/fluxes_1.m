...
for iy=yrst:1:yren
    ...
    for imo=most:1:moen
        ...
        indxlat = find(LAT(1,:)>= -15 & LAT(1,:)<=-14);
        indxlon = find(LON(:,1)>= -80.5 & LON(:,1)<=-75.5);
        ...
        for ii=0:-10:-300
            jj=jj+1;
            NP1new(:,:,jj) = vinterp(NP1,zz1,ii);
            NP2new(:,:,jj) = vinterp(NP2,zz1,ii);
...
%% save
save('Limitation_Nflux_1415.mat','NP1L','NP2L');
NPL = NP2L + NP1L;
%% 
% figure
% for ii=32:-1:1
